...
function setGridParameters() {
    ...
    columns =
    [
        { id: "SactionResultId", name: "SactionResultId", field: "SactionResultId" },
        ...
        { id: "SactionResult", name: "Saction Result", field: "SactionResult" },
        { id: "SactionComments", name: "Saction Comments", field: "SactionComments" },
...
function PassSaction() {
    ...
    for (var i = 0; i < UpData.length; i++) {
        UpData[i].SactionResultId = 1;
    }
    PostData();
   
}

function FailSaction() {
