...
function setGridParameters() {
    ...
    columns =
    [
        { id: "FinSurvResultId", name: "FinSurvResultId", field: "FinSurvResultId" },
        ...
        { id: "FinSurvResult", name: "FinSurv Result", field: "FinSurvResult" },
        { id: "FinSurvComments", name: "FinSurv Comments", field: "FinSurvComments" },
...
function PassFinSurv() {
    ...
    for (var i = 0; i < UpData.length; i++) {
        UpData[i].FinSurvResultId = 1;
    }
    PostData();
   
}

function FailFinSurv() {
