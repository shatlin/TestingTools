...
function setGridParameters() {
    ...
    columns =
    [
        { id: "WSSResultId", name: "WSSResultId", field: "WSSResultId" },
        ...
        { id: "WSSResult", name: "WSS Result", field: "WSSResult" },
        { id: "WSSComments", name: "WSS Comments", field: "WSSComments" },
